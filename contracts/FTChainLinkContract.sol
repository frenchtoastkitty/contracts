 ...
 * local test networks
 */
contract FTChainLinkContract is ChainlinkClient, Ownable {
  // solium-disable-next-line zeppelin/no-arithmetic-operations
  uint256 constant private ORACLE_PAYMENT = 1 * LINK;
  bytes32 public data;

  // Creates constants for the JobIDs within the documentation, Rinkeby.
   ...
   * @param _path The dot-delimited path to parse of the response
   */
  function createWeatherRequestTo(
    address _oracle,
    bytes32 _jobId,
    string _url,
    string _path
